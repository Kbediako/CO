...
function buildReviewOutcomeGuidanceSection(): string[] {
  return [
    ...
    '- When `review/telemetry.json` reports `review_verdict: unknown` or omits `review_verdict`, treat the semantic verdict as a review-handoff blocker until a fresh review produces `review_verdict: clean` or an explicit break-glass waiver records owner, expiry, reason, and evidence.',
