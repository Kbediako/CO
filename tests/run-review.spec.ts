...
{"schema_version":"co.review.contract.v1","generated_at":"2026-05-18T00:00:00.000Z","overall_verdict":"clean","axes":{"spec_conformance":{"verdict":"clean","summary":"Spec checked.","clean_signal":"Spec checked.","evidence_refs":[{"path":"$evidence_rel","sha256":"$evidence_sha","description":"spec bundle"}],"findings":[]},"coding_standards":{"verdict":"clean","summary":"Standards checked.","clean_signal":"Standards checked.","evidence_refs":[{"path":"$evidence_rel","sha256":"$evidence_sha","description":"spec bundle"}],"findings":[]},"code_changes":{"verdict":"clean","summary":"Code checked.","clean_signal":"Code checked.","evidence_refs":[{"path":"$evidence_rel","sha256":"$evidence_sha","description":"spec bundle"}],"findings":[]},"agent_loop":{"verdict":"clean","summary":"Agent loop checked.","clean_signal":"Agent loop checked.","evidence_refs":[{"path":"$evidence_rel","sha256":"$evidence_sha","description":"spec bundle"}],"findings":[]}},"review_intent_matrix":{"original_spec":{"required":true,"verdict":"clean","evidence":["Spec checked."],"proposed_fixes":["No change proposed; Spec checked."]},"coding_standards":{"required":true,"verdict":"clean","evidence":["Standards checked."],"proposed_fixes":["No change proposed; Standards checked."]},"code_change_proposals":{"required":true,"verdict":"clean","evidence":["Code checked."],"proposed_fixes":["No change proposed; Code checked."]},"agent_loop_change_proposals":{"required":true,"verdict":"clean","evidence":["Agent loop checked."],"proposed_fixes":["No change proposed; Agent loop checked."]}},"code_change_proposals":[],"agent_loop_proposals":[]}
JSON
)"
