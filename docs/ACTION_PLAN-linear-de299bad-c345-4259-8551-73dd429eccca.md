...
## Acceptance Criteria
- [x] Timeout reproduced and slow path identified as repeated git fixture/subprocess assertion setup inside single Vitest cases.
- [x] False reviewer-approval, negated external signal, and empty deprecation-plan label assertions remain present and strict.
