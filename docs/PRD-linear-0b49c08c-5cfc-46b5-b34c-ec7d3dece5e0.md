...
- The fresh attempt starts after a full Rework reset: stale PR `#394` was closed, the old Linear workpad was deleted, and branch `linear/co-88-repo-cleanup-truthfulness` was recreated from fresh `origin/main`.
...
## Non-Goals
- Reopening the old broad CO-88 attempt or replaying unrelated changes from closed PR `#394`.
