...
## Next evals
- Multi-day initiative (48–72h) with multiple resumes (queued).
...
- Notes: Requires keeping the orchestrator session alive; resume will be triggered via control endpoint after 24h. Tracking issue: [tracking issue](https://github.com/Kbediako/CO/issues/178).
