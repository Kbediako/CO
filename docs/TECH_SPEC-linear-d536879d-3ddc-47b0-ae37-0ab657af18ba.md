...
- Minor-seam decision: acceptable only as removal of stale cached-summary priority in the existing runtime/read-model boundary; no new fallback, compatibility, or break-glass status path is added.
