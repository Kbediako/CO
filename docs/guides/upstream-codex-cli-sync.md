...
- Record behavioral deltas that can affect CO:
  ...
  - advanced feature gates (`js_repl`, `memories` (legacy alias `memory_tool`), sqlite) and their cloud/local compatibility semantics (including `js_repl` default-on + break-glass toggles)
