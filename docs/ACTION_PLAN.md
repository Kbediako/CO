...
- Metrics targets support the PRD goal of 95% reviewer coverage from artifacts; the remaining low-risk item (Agents SDK pin) proceeds as an implementation task without additional specs.
