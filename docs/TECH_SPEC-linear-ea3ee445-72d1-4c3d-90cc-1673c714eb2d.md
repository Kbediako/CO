...
## Summary
- Objective: make explicit commit/base standalone-review launches execute truthfully by removing unsupported inline prompt delivery from scoped Codex review calls while keeping wrapper-side evidence intact.
- Scope:
