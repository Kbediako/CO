...
- Preserve the post-#728 current-main finding that `CO-430` also reached terminal `Done` after briefly carrying integrated owner metadata; `CO-430` is historical evidence, not the live owner.
...
- Update `docs/guides/docs-freshness-cohorts.md`, `tasks/index.json`, `docs/TASKS.md`, and the CO-427 packet/mirrors so they describe the active owner repair and retain terminal CO-425/CO-430 lineage instead of future packet-only work.
...
- Owner repair validation must show:
  ...
  - `docs/guides/docs-freshness-cohorts.md` names `CO-427` as current owner and keeps `CO-425` plus `CO-430` as terminal historical evidence
