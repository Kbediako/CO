...
- Desired Outcome: explicit commit-scoped and base-scoped standalone review invocations run successfully, while the wrapper still saves prompt/context artifacts and describes scoped-launch behavior truthfully in help, docs, and telemetry.
...
- Success criteria / acceptance:
  ...
  - wrapper help/docs and telemetry stay truthful about what context is or is not passed to `codex review` in scoped modes
