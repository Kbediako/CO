...
- Heavy-command policy toggles:
  - Allow unrestricted heavy command execution (and direct validation-runner launches): `CODEX_REVIEW_ALLOW_HEAVY_COMMANDS=1`
