...
- [x] `node scripts/spec-guard.mjs --dry-run` passes - Evidence: `.runs/0914-npm-companion-package/cli/2025-12-28T16-56-08-294Z-ef7e1d81/manifest.json`.
- [x] `npm run build` passes - Evidence: `.runs/0914-npm-companion-package/cli/2025-12-28T16-56-08-294Z-ef7e1d81/manifest.json`.
- [x] `npm run lint` passes - Evidence: `.runs/0914-npm-companion-package/cli/2025-12-28T16-56-08-294Z-ef7e1d81/manifest.json`.
- [x] `npm run test` passes - Evidence: `.runs/0914-npm-companion-package/cli/2025-12-28T16-56-08-294Z-ef7e1d81/manifest.json`.
