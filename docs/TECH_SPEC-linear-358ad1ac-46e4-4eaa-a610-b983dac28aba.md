# TECH_SPEC - CO: promote resident app-server seam to authoritative provider-worker control plane
...
The parent lane verified the shared source payload at `../../.runs/linear-358ad1ac-46e4-4eaa-a610-b983dac28aba/cli/2026-04-26T03-48-02-269Z-9be693a5/memory/source-0/source.txt`, so this spec is anchored on `ctx:sha256:1d9326aedeb79238be318d1be827130d7e533ba7c4b559c24f7f31873770193c#chunk:c000001`, the parent-provided lane prompt, and protected terms. Parent owns all implementation, Linear/workpad state, validation, PR lifecycle, and any docs mirrors outside this child lane's declared file scope.
