...
4. Restore same-attempt parity follow-up suppression and deterministic parent-dirty child-lane sequencing/guidance, then run focused regression coverage and the normal validation/review gates.
## Validation
