...
- Reset facts:
  ...
  - reset branch `linear/co-88-repo-cleanup-truthfulness` to fresh `origin/main`
...
2. Run audited docs-review and fold any packet-only corrections into the docs before code edits.
