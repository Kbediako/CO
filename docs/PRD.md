...
- **2025-10-18 Update:** Drafted `tasks/specs/0005-mcp-runner-enhancements.md` to govern directory migration, heartbeat/resume, and metrics logs; structured error artifacts now land under `errors/<index>-<slug>.json` with manifest references (2025-10-19 implementation), while diagnostics prompts and SDK pinning remain queued per task checklist section 7.
