...
- **Open Items:** Normalize manifest locations vs. task directories and continue tuning heartbeat/resume telemetry once reviewer dashboards stabilize.
- **2025-10-18 Update:** Drafted `tasks/specs/0005-mcp-runner-enhancements.md` to govern directory migration, heartbeat/resume, and metrics logs; structured error artifacts now land under `errors/<index>-<slug>.json` with manifest references (2025-10-19 implementation), diagnostics prompts shipped 2025-10-19 with manifest summaries directing `scripts/run-mcp-diagnostics.sh --no-watch`, and Agents SDK versions were pinned on 2025-10-19 (see `.runs/0001/mcp/2025-10-19T07-25-23-684Z-60187/manifest.json`).
