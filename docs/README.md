...
- **Advanced feature posture:** `js_repl` is approved for task-scoped opt-in lanes (with manifest evidence), but remains off by default globally; `memory_tool` remains scoped to explicit eval lanes.
