...
## Current Posture
- Current CO-local ChatGPT-auth/appserver and marketplace posture: Codex CLI `0.125.0`; release-facing cloud pins stay on the explicit promoted candidate in the version policy.
