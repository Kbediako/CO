...
## Summary
- Objective: land a narrowed CO-88 cleanup pass from fresh `origin/main` that removes dead truthfulness debt and keeps only compatibility paths with explicit rationale.
- Scope:
