# PRD - Subagent Delegation Enforcement (Task 0918)

Source of truth: `tasks/0918-prd-subagent-delegation-enforcement.md`.
...
- Documentation updates must keep delegation requirements visible in AGENTS/SOPs/templates.
