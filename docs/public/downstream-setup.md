...
- CO currently targets Codex CLI `0.124.0`; CO-352 evaluated `0.125.0` model-catalog posture and held promotion/default changes, so newer candidates stay evidence-gated in the version policy.
