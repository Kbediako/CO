...
- Low-risk backlog items now focus on telemetry tuning; Agents SDK pinning shipped on 2025-10-19 with reviewer evidence in `.runs/0001/mcp/2025-10-19T07-25-23-684Z-60187/manifest.json`. Diagnostics prompt shipped 2025-10-19 with `manifest.summary` recommending `scripts/run-mcp-diagnostics.sh --no-watch`, and structured error artifacts shipped 2025-10-19 with `errors/<index>-<slug>.json` captured per failed command.
