...
5. Add focused tests for metadata and behavior activation/non-activation.
...
- focused provider workflow test command covering metadata and retained-claim paths
- `npm run docs:check`
