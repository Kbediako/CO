...
2. Tighten the standalone-review execution-state logic so post-anchor `review-closeout-bundle` rereads fail promptly instead of consuming the full generic timeout budget.
