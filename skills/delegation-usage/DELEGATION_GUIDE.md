...
- Recommended baseline:
  ...
  - Add optional `[agents.awaiter]` override for `gpt-5.5` + `xhigh` while preserving awaiter instructions.
  - Add `[agents.worker_complex]` for high-risk edits (`gpt-5.5`, `xhigh`).
