# Task Checklist — 0922-docs-freshness-systemization (0922)

> Set `MCP_RUNNER_TASK_ID=0922-docs-freshness-systemization` for orchestrator commands. Mirror status with `tasks/tasks-0922-docs-freshness-systemization.md` and `docs/TASKS.md`. Flip `[ ]` to `[x]` only with manifest evidence (e.g., `.runs/0922-docs-freshness-systemization/cli/<run-id>/manifest.json`).
