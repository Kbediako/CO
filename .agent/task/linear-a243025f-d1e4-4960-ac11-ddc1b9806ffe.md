...
## Notes
- Mirror of `tasks/tasks-linear-a243025f-d1e4-4960-ac11-ddc1b9806ffe.md`; parent provider worker owns implementation, validation, workpad, PR lifecycle, and review handoff.
