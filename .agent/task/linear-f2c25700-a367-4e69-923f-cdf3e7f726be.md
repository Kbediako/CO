...
## Handoff
- [ ] Workpad refreshed after docs-first, after implementation, and immediately before any review handoff. Evidence: initial + post-implementation refresh complete; final pre-handoff refresh pending.
- [ ] PR attached before any review-state transition. Evidence: pending.
