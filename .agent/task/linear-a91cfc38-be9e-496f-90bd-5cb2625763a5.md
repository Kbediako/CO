...
- [ ] External docs freshness owner replacement pending: CO-575 is terminal for `docs:freshness:maintain`; CO-579 packet traceability remains the successor blocker before docs freshness can pass.
