...
- [x] Focused provider-handoff regression passed.
- [x] Full provider-worker validation floor passed before current-main merge.
- [x] Standalone review rerun clean with valid enforced contract.
