...
- [x] Parent drains PR feedback and transitions Linear handoff. Evidence: PR #723 feedback fixes are ready to commit/push; CodeRabbit inline replies and the final `ready-review` drain remain pending.
