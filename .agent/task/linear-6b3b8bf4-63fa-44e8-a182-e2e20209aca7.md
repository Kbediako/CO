# Task Checklist Mirror - linear-6b3b8bf4-63fa-44e8-a182-e2e20209aca7

> Set `MCP_RUNNER_TASK_ID=linear-6b3b8bf4-63fa-44e8-a182-e2e20209aca7` for parent-owned orchestrator commands. Mirror status with `tasks/tasks-linear-6b3b8bf4-63fa-44e8-a182-e2e20209aca7.md` and `docs/TASKS.md` after the parent accepts this child patch.
