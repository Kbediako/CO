...
> Set `MCP_RUNNER_TASK_ID=0949-release-readme-followups` for orchestrator commands. Mirror with `docs/TASKS.md` and `tasks/tasks-0949-release-readme-followups.md`. Flip `[ ]` to `[x]` only with manifest evidence.
