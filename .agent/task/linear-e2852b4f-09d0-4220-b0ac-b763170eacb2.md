...
- [x] Checklist mirrors name `Overview` and `Bug Fixes` wherever release-note promotion evidence is recorded. Evidence: this checklist and `tasks/tasks-linear-e2852b4f-09d0-4220-b0ac-b763170eacb2.md`.
