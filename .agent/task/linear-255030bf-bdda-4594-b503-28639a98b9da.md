...
- [x] `MCP_RUNNER_TASK_ID=linear-255030bf-bdda-4594-b503-28639a98b9da DIFF_BUDGET_OVERRIDE_REASON="..." node scripts/diff-budget.mjs`. Evidence: override accepted because the docs-first packet plus tightly coupled lifecycle/query/test changes leave the lane `61` lines over the `1200`-line budget.
