...
- [x] Unresolved actionable review threads are `0`, or a waiver is recorded with evidence before merge. Evidence: PR `#284`; review threads `PRRT_kwDOQE1BPc518iab` and `PRRT_kwDOQE1BPc518iac` resolved on `2026-03-22T05:00:32Z`.
