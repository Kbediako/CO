...
> Set `MCP_RUNNER_TASK_ID=0947-delegation-skill-ship` for orchestrator commands. Mirror with `docs/TASKS.md` and `tasks/tasks-0947-delegation-skill-ship.md`. Flip `[ ]` to `[x]` only with manifest evidence.
...
- [x] Mirrors updated in `docs/TASKS.md` and `tasks/tasks-0947-delegation-skill-ship.md` — Evidence: `docs/TASKS.md`, `tasks/tasks-0947-delegation-skill-ship.md`, `tasks/index.json`, `docs/docs-freshness-registry.json`.
