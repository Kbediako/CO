...
- Cite `.runs/0520-15th-plus-hi-fi/cli/2025-11-14T10-51-49-459Z-fb52f4b5/manifest.json` and `archives/hi-fi-tests/15th-plus/2025-11-14T10-51-49-459Z-fb52f4b5/` whenever updating run status.
...
1. **Toolkit run completed**
   ...
   - Evidence: `.runs/0520-15th-plus-hi-fi/cli/2025-11-14T10-51-49-459Z-fb52f4b5/manifest.json` (extract → tokens → reference → spec-guard → artifact writer).
   - [x] Status
2. **Archive + reference refresh**
   - Tasks: Copy `.runs/0520-15th-plus-hi-fi/2025-11-14T10-51-49-459Z-fb52f4b5/artifacts/design-toolkit/**` into `archives/hi-fi-tests/15th-plus/2025-11-14T10-51-49-459Z-fb52f4b5/`, prune `.runs/.../artifacts`, and update `reference/plus-ex-15th/README.md` + loader macro.
   - [x] Status
3. **Local validation**
