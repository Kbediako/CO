# Task Checklist — 0925-tasks-archive-automation (0925)

> Set `MCP_RUNNER_TASK_ID=0925-tasks-archive-automation` for orchestrator commands. Mirror status with `tasks/tasks-0925-tasks-archive-automation.md` and `docs/TASKS.md`. Flip `[ ]` to `[x]` only with manifest evidence (e.g., `.runs/0925-tasks-archive-automation/cli/<run-id>/manifest.json`).
