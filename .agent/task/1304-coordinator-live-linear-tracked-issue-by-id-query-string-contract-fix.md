...
- [x] Unresolved actionable review threads verified as `0`, or waiver recorded with evidence, before merge. Evidence: PR `#279` thread audit via `gh api graphql ... reviewThreads ...` on 2026-03-19 after required checks and CodeRabbit reached terminal success on head `83004de91`.
