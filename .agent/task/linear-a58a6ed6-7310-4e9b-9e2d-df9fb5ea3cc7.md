...
- [x] PR attached and `pr ready-review` drain clean before In Review. Evidence: pending PR creation, checks, feedback sweep, and drain.
...
- [x] Parent opens and attaches PR. Evidence: pending after final standalone review and elegance completion.
- [x] Parent refreshes Linear workpad and transitions to In Review only after clean validation and feedback drain. Evidence: pending PR checks and `pr ready-review` clean drain.
