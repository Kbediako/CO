...
- [x] `codex login --device-auth` surface captured from login help output. Evidence: `out/linear-acdc2c4c-b8b1-46e8-8e21-c9a9c014213d/manual/codex-0120-audit/codex-login-device-auth.txt`.
