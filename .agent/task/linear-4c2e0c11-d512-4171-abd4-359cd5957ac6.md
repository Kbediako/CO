...
- [x] PR branch canary gate is required for this marketplace lane. Evidence: GitHub `Cloud Canary` passed on PR #639 before the final review-feedback amend; the final head must pass the same PR gate before handoff. This is PR gate evidence, not a broad active/cloud promotion claim.
