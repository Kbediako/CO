...
- [x] Parent implementation gates through package smoke. Evidence: required gates through pack smoke passed before final classifier rework; latest focused regressions passed 390 tests after the current forced-review P2 fixes, affected run-review subset passed 3 tests / 170 skipped, and current-turn `npm run build` passed.
