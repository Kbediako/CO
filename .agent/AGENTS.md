<!-- codex:instruction-stamp 3a8b7e5aec6775222e24da7759cd5b8581905032f794b34b2b166a184cb7b615 -->
# Agent Enablement
...
- Upstream `rust-v0.128.0` removed `js_repl` and `js_repl_tools_only`, and current local `0.130.0` still reports both as removed; do not set `CODEX_CLOUD_ENABLE_FEATURES` / `CODEX_CLOUD_DISABLE_FEATURES` to either `js_repl` or `js_repl_tools_only`, or run `codex features enable/disable js_repl` / `codex features enable/disable js_repl_tools_only`. Use cloud feature env vars only for active non-removed feature names after checking `codex features list`.
