<!-- codex:instruction-stamp 12625fb91d0b4f303db925760bbc204346bc6779ee11da318f0100ee0bdefce0 -->
# Agent Enablement
...
- Oracle runs must follow `.agent/SOPs/oracle-usage.md` (4-file max per run, no duplicate basenames, attachments-first workflow).
