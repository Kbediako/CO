<!-- codex:instruction-stamp 156049581ec629a5fd04e61490a06185bac714e2e643af0f50bdb1714f48abde -->
# Agent Enablement
...
- Oracle runs must follow `.agent/SOPs/oracle-usage.md` (tool cap: hard 20 attachments, target 18, 21+ auto-bundles; no duplicate basenames; attachments-first workflow).
