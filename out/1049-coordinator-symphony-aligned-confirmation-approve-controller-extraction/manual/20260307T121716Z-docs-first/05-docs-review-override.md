...
- Verified cause: `1049` had just been registered and no subordinate `1049-*` delegated manifest existed yet, so the top-level docs-review lane could not satisfy the repo delegation contract on first registration.
