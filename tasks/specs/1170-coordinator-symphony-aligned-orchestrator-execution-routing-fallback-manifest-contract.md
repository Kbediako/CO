...
Narrow the remaining fallback manifest/error-note contract inside `orchestratorExecutionRouter.ts` after the broader `1169` router-local policy split.

## Scope

- router-local fallback manifest/error-note shaping
