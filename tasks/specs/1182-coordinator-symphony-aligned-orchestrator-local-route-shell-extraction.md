...
review_notes:
  - 2026-05-16: CO-545 strict spec-guard audit reclassified this stale Apr 14/15 row as inactive done; same-file checklist `tasks/tasks-1182-coordinator-symphony-aligned-orchestrator-local-route-shell-extraction.md` has 19 checked items and 0 unchecked items, so the old draft status was stale metadata rather than active implementation work.
---
