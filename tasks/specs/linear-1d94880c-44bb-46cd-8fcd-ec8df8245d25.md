...
- Safeguard ownership split: parent owns docs, implementation, tests, Linear mutation, and final review. Child lane `fixture-contract-scout` owns only `out/linear-1d94880c-44bb-46cd-8fcd-ec8df8245d25/fixture-contract-scout.md` until parent accepts/rejects/invalidates it.
