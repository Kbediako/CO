...
## Open Questions
- Should terminal failure produce a blocking action-required reason until a manual retry occurs, or clear pending while requiring an explicit waiver? Implementation must select one and document it.
