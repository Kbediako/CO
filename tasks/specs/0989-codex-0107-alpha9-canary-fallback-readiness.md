...
- Documented fallback gate command (`CODEX_CLOUD_CANARY_REQUIRED=1 CLOUD_CANARY_EXPECT_FALLBACK=1`) failed for both channels, so prerelease advancement remains `hold`.
