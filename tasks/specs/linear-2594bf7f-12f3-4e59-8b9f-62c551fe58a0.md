...
review_notes:
  - 2026-04-18: Parent prompt scoped this child lane to docs-only packet generation for `CO-233` with canonical task id `20260418-linear-2594bf7f-12f3-4e59-8b9f-62c551fe58a0`; parent retains implementation, tests, workpad, Linear state, PR lifecycle, and full validation ownership.
  - 2026-04-18: The packet is anchored on the authoritative provider-worker prompt source `../../.runs/linear-2594bf7f-12f3-4e59-8b9f-62c551fe58a0/cli/2026-04-18T01-28-52-748Z-ffa1574a/memory/source-0/source.txt` plus current repo seams in `selectedRunProjection.ts`, `providerLinearWorkerRunner.ts`, and `providerLinearChildLaneShell.ts`.
