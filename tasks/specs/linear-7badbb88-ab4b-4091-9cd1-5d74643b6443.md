...
## Non-Goals
No CO-470 fixture-env cleanup, CO-472 rewrite, manual provider-intake edit, direct `provider-linear-worker` launch, WIP/admission cap relaxation, or timeout masking.
