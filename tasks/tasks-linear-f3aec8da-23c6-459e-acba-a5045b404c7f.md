...
- [x] Parent focused review-wrapper telemetry and handoff regressions. Evidence: `npx vitest run tests/review-execution-telemetry.spec.ts orchestrator/tests/CommandRunnerReviewEvidenceConsistency.test.ts orchestrator/tests/ProviderLinearWorkerRunner.test.ts` passed 389 tests after the current forced-review P2 fixes; affected `tests/run-review.spec.ts` subset passed 3 tests / 170 skipped.
