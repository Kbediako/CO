...
- [x] CO-scoped version policy decision recorded (adopt or hold). - Evidence: `out/0985-co-release-0-1-37-codex-0-107-canary/manual/codex-version-canary/compare/decision-go-no-go.md` (decision: GO for CO-repo alpha adoption, keep global default at stable `0.106.0` until broader repo coverage justifies promotion).
