...
- [x] Follow-on parity audit confirmed two narrower remaining deltas: live-team `Ready` still needs explicit `Todo`-equivalent routing, and CO `Rework` still diverges from Symphony by reusing the old PR/workpad instead of resetting. Evidence: `symphony@a164593aacb3db4d6808adc5a87173d906726406: elixir/WORKFLOW.md`, `symphony@a164593aacb3db4d6808adc5a87173d906726406: elixir/README.md`, `skills/linear/SKILL.md`, live `issue-context` output on 2026-03-23.
