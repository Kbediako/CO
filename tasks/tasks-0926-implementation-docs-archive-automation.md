# Task Checklist - Implementation Docs Archive Automation (0926)

> Set `MCP_RUNNER_TASK_ID=0926-implementation-docs-archive-automation` for orchestrator commands. Mirror with `docs/TASKS.md` and `.agent/task/0926-implementation-docs-archive-automation.md`. Flip `[ ]` to `[x]` only with manifest evidence.
