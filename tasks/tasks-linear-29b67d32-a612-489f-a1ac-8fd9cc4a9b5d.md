...
- `npm run test:core -- orchestrator/tests/ProviderIssueHandoff.test.ts` passed 417 tests.
- `npm run test` passed 360 files / 5650 tests.
- `npm run docs:check` passed.
- `npm run repo:stewardship` passed.
- `node scripts/diff-budget.mjs` passed, files=9/25 and lines=710/1200.
