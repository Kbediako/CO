...
- [x] Required cloud canary for Codex CLI `0.123.0` completed and classified pass. Evidence: `reference/linear-919ecdfa-9be9-4d93-995b-7f8e4a784e6f/cloud-gates/required-manifest.json`; cloud task `task_e_69e9ef5628408327b88b1fcd0ab14b24`, status `ready`, environment `Kbediako/CO`, poll count `24`.
- [x] Fallback cloud contract for Codex CLI `0.123.0` completed and classified pass. Evidence: `reference/linear-919ecdfa-9be9-4d93-995b-7f8e4a784e6f/cloud-gates/fallback-manifest.json`; fallback `mode_requested=cloud`, `mode_used=mcp`, issue `missing_environment`.
