...
- [x] Full repo validation suites are intentionally not run by this child lane. Evidence: child-lane constraints prohibit full repo validation suites.

## Handoff
- [ ] Parent lane accepts or adjusts this patch, then continues owning Linear workpad, GitHub secret/permission repair, archive PR validation, PR lifecycle, and review-state transition. Evidence: pending parent patch import.
