...
- [x] Reference README + loader refreshed — `reference/plus-ex-15th/README.md` points to the archive + manifest, `reference/plus-ex-15th/scripts/loader-scroll-macro.js` unlocks ScrollSmoother on localhost.
