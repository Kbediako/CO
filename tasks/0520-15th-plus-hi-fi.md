...
## Archive + Reference
- [x] Artifacts mirrored — `archives/hi-fi-tests/15th-plus/2025-11-14T11-11-13-442Z-6897b063/` copies `design-toolkit/{context,tokens,styleguide,reference,diffs,motion}` prior to pruning `.runs/.../artifacts`.
...
## Validation + Hygiene
- [x] Local clone check — `npx serve archives/hi-fi-tests/15th-plus/2025-11-14T11-11-13-442Z-6897b063/artifacts/design-toolkit/reference/plus-ex-15th -l 4173` + Playwright probe confirm `document.body.dataset.toolkitScrollUnlocked === 'true'` and `40` `[data-section]` nodes rendered with no `/assets/assets/**` requests (Playwright output `{"unlocked":"true","sectionCount":40}`).
