...
- [ ] PR opened with scope/decisions/validation evidence. - Evidence: `<pr-url>`, `out/0983-runtime-default-flip-readiness-automation/manual/pr-create.log`.
- [ ] Review feedback addressed in-thread with reruns. - Evidence: `<discussion-links>`, rerun logs.
- [ ] Quiet-window monitoring completed after green checks. - Evidence: `out/0983-runtime-default-flip-readiness-automation/manual/pr-watch-merge.log`.
- [ ] Merge complete and branch cleaned up (if unblocked). - Evidence: `<merge-commit-sha>`, watch log.
