...
- [x] Standalone review approval captured - Evidence: parent run review telemetry status `succeeded`, review outcome `bounded-success`; repo-relative review evidence is captured in `.runs/linear-8bd36e2e-2e54-4c8d-ae79-7b1319fc6adc-docs-review/cli/2026-05-01T16-49-31-779Z-1304879a/review/telemetry.json`.
