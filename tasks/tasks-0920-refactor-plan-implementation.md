...
> Set `MCP_RUNNER_TASK_ID=0920-refactor-plan-implementation` for orchestrator commands. Mirror with `docs/TASKS.md` and `.agent/task/0920-refactor-plan-implementation.md`. Flip `[ ]` to `[x]` only with manifest evidence.
