...
- Child-lane caveat: the declared source payload is absent from this checkout; this checklist preserves the parent-provided issue constraints and evidence paths.
