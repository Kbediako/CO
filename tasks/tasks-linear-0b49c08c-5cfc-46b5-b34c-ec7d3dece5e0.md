...
## Validation
- [x] Focused tests cover the touched SDK and static UI truthfulness seams. Evidence: `npx vitest run packages/sdk-node/tests/orchestrator.exec.test.ts packages/sdk-node/tests/orchestrator.artifacts.test.ts orchestrator/tests/RlmAlignment.test.ts`, plus `npx vitest run tests/cli-command-surface.spec.ts packages/sdk-node/tests/orchestrator.artifacts.test.ts`.
...
- [x] Manifest-backed standalone review plus explicit elegance review are recorded before any review handoff. Evidence: `out/linear-0b49c08c-5cfc-46b5-b34c-ec7d3dece5e0/manual/standalone-review.md` and `out/linear-0b49c08c-5cfc-46b5-b34c-ec7d3dece5e0/manual/elegance-review.md`.
