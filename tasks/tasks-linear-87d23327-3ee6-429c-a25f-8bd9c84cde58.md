...
- [x] Required repo validation floor is green for the current diff except the final standalone-review and elegance gates. Evidence: `out/linear-87d23327-3ee6-429c-a25f-8bd9c84cde58/manual/20260410T101130Z-post-fix-validation/01-delegation-guard.log`, `02-spec-guard.log`, `03-build.log`, `04-lint.log`, `05-test.log`, `06-docs-check.log`, `07-docs-freshness.log`, `08-diff-budget.log`.
- [ ] Manifest-backed standalone review plus explicit elegance review are recorded before handoff. Evidence: pending.
